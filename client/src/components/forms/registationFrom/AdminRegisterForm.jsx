...
import { useAdminRegistrationMutation } from "@/app/api/auth";
...
const AdminRegistrationForm = () => {
  ...
  const [adminRegistration,{data,error,isError,isLoading,isSuccess}]=useAdminRegistrationMutation()
  ...
  return (
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <input type="text" {...register('role')} value="admin" className="hidden"/>
      </div>
      <div>
