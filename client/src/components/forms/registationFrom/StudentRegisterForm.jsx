...
import { useStudentRegistrationMutation } from "@/app/api/auth";
...
const StudentRegistrationForm = () => {
  const [studentRegistration, { data, error, isError, isLoading, isSuccess }] = useStudentRegistrationMutation()
  ...
  const onSubmit = async (formData) => {
    ...
    try {
      const response = await studentRegistration(formData).unwrap();;
