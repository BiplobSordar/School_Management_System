...
const RoleBaseLayout = () => {
    ...
    return (
        <div className="flex h-screen">
            {/* Sidebar */}
            <aside
                className={`fixed top-0 z-50 left-0 h-screen w-60  bg-gray-900 text-white p-5 shadow-lg transition-transform duration-300 ease-in-out 
            ...
            {/* Main Content */}
            <div
                className={`flex-1 overflow-y-auto scrollbar-hidden p-5 bg-gray-100 transition-all duration-300 ${isSidebarOpen ? "opacity-100 sm:opacity-100" : "opacity-100"
                    }`}
